...
keywordsSecondary:
  - smartloop
  - gagner du temps d'écran
  - contrôle parental sans conflit
...
faq:
  ...
  - q: Est-ce que je peux quand même lui donner du temps à la main ?
    a: >-
      ...
      pouvez aussi tout mettre en pause d'un bouton.
  - q: Et s'il n'a rien gagné du tout ?
    a: >-
      Il garde l'accès aux appels et à ce que vous avez laissé disponible. Il ne
...
C'est toute la différence. L'enfant ne subit pas une punition, il gère un budget.
...
Ce n'est pas une idée sortie de nulle part. Les psychologues appellent ça le principe de Premack : on obtient plus facilement une activité peu attirante quand elle donne accès à une activité désirée. C'est le même mécanisme que « tu sors de table quand tu as fini ton assiette », en version numérique et automatique.

Ce que ça change concrètement à la maison :

- l'enfant sait exactement comment récupérer du temps, donc il arrête de vous le réclamer ;
- il n'y a plus de coupure vécue comme injuste, donc plus de raison de chercher à contourner ;
- vous n'êtes plus le gendarme. Vous redevenez simplement le parent.
