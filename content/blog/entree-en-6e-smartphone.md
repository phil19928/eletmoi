...
faq:
  ...
  - q: Et le téléphone au collège ?
    a: >-
      ...
      s'étend désormais au lycée. Le règlement intérieur de son établissement
      précise les modalités.
  - q: 'Un téléphone d''occasion, bonne ou mauvaise idée ?'
    a: >-
      Bonne idée pour le premier. Il sera cassé ou perdu, statistiquement.
      Vérifiez simplement qu'il reçoit encore les mises à jour de sécurité.
  - q: Faut-il lui donner un forfait avec internet ?
    a: >-
      Pas forcément la première année. Un petit forfait suffit souvent, et
      limite mécaniquement l'usage à l'extérieur.
  - q: Que faire s'il refuse toute règle ?
    a: >-
      Ne donnez pas le téléphone. C'est le seul moment où vous avez un vrai
      levier : avant.
howToSteps: []
cta:
...
Vous allez l'entendre cet été. Peut-être que c'est même vrai dans sa classe. Et vous hésitez, parce que vous savez très bien que le jour où vous dites oui, vous ne revenez pas en arrière.
...
## Si vous dites oui : à faire avant de lui donner

Ne lui tendez pas le téléphone dans son emballage en lui disant « on verra les règles plus tard ». Ce moment ne reviendra jamais. Comptez trente minutes, la veille.

1. **Créez son compte avec lui**, avec sa vraie date de naissance. C'est ce qui déclenche les protections prévues pour les mineurs.
2. **Désactivez les achats** ou exigez un mot de passe pour chaque téléchargement.
3. **Installez ce dont il a besoin** et rien d'autre pour l'instant. On ajoute au fur et à mesure.
4. **Réglez les heures sans téléphone** : la nuit, les devoirs, les repas. En 6e, la nuit est le point le plus important. Le téléphone dort dans le salon.
5. **Mettez en place un cadre pour le temps d'écran** avant qu'il découvre TikTok, pas après. Une règle posée le premier jour est une règle. Une règle posée trois mois plus tard est une sanction.
