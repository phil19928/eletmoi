...
metaDescription: >-
  Combien de temps d'écran par jour selon l'âge de votre enfant ? Les repères
  des experts, ce qui compte vraiment, et comment fixer une règle qui tient.
h1: Combien de temps d'écran par âge ?
keywordPrimary: temps d'écran par âge
keywordsSecondary:
  - combien de temps d'écran enfant
  - temps d'écran adolescent
...
faq:
  ...
  - q: Faut-il compter le temps d'écran fait pour l'école ?
    a: >-
      ...
      passif, pas les devoirs sur ordinateur.
  - q: Mon enfant dit que ses copains ont beaucoup plus.
    a: >-
      C'est probablement vrai pour certains. Ça ne change rien à ce qui est bon
      pour lui, et vous pouvez le lui dire calmement.
  - q: Faut-il supprimer complètement les écrans ?
    a: >-
      Non, et ce serait contre-productif. Un enfant coupé de tout se retrouve
      exclu socialement et n'apprend rien de l'usage raisonnable.
  - q: À partir de quand puis-je lui laisser gérer seul ?
    a: >-
      Progressivement à partir de 15-16 ans, en gardant une limite de nuit.
      C'est justement le moment où l'autonomie s'apprend, tant qu'il est encore
      chez vous.
howToSteps: []
cta:
...
imageAlt: >-
  Un parent et son enfant fixent ensemble une règle de temps d'écran adaptée à
  son âge
---
