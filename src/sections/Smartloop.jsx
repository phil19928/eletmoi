...
const explainers = [
    {
        ...
        description: "Vous décidez : 10 min d'apprentissage = 20, 30 ou 40 min de divertissement.",
        icon: (
    ...
    },
    {
        ...
        description: "Parent : ajoute, retire ou bloque les apps divertissement en un clic. Sans négociation.",
        icon: (
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className="w-6 h-6 text-primary">
    ...
    {
        title: "Blocage auto",
        description: "École, nuit, repas : le divertissement se coupe. Sans discussion.",
        icon: (
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className="w-6 h-6 text-primary">
