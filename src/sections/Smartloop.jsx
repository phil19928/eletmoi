...
const explainers = [
    {
        title: "Ratio reglable",
        description: "Vous decidez : 10 min d'apprentissage = 20, 30 ou 40 min de divertissement.",
        icon: (
    ...
    {
        title: "Missions bonus",
        description: "Ranger sa chambre, sortir le chien... photo, validation, bonus.",
        icon: (
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className="w-6 h-6 text-primary">
    ...
    {
        title: "Blocage auto",
        description: "Ecole, nuit, repas : le divertissement se coupe. Sans discussion.",
        icon: (
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className="w-6 h-6 text-primary">
            ...
            <Container>
                <div className="text-center mb-12">
                    ...
                    <p className="mt-4 text-slate-500 max-w-lg mx-auto text-lg">
                        Une regle simple que votre enfant comprend en 10 secondes.
                    </p>
                </div>
