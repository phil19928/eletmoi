...
const lines = [
    {
        text: "Vous connaissez cette scene.",
        className: "text-2xl sm:text-3xl lg:text-4xl font-bold text-white",
        delay: 0,
    },
    {
        text: "Il est 19h. Votre enfant est sur TikTok depuis une heure. Vous dites \u00AB encore 5 minutes \u00BB. Il dit \u00AB oui oui \u00BB. 20 minutes plus tard, c'est le conflit.",
    ...
    {
        text: "Et si le telephone avait des regles claires, acceptees par tout le monde ?",
    ...
    return (
        <section className="relative py-24 sm:py-32 overflow-hidden">
            ...
            <Container className="relative z-10">
                <div ref={ref} className="flex flex-col items-center text-center gap-8 sm:gap-10">
                    {/* Confused mascot */}
                    <motion.img
                        src={mascotConfused}
