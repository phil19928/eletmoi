...
const features = [
    {
        ...
        description:
            "L'app Parent (web) controle. L'app Enfant (Android) applique. Connectees par QR code en 30 secondes.",
        visual: (
            <div className="flex items-center justify-center gap-4 sm:gap-6">
                ...
                <div className="w-20 sm:w-24 h-36 sm:h-44 rounded-2xl border-2 border-primary/30 bg-primary-very-light/50 flex flex-col items-center justify-center gap-2 relative">
                    <svg viewBox="0 0 24 24" fill="none" stroke="#6D98C2" strokeWidth="1.5" className="w-8 h-8">
                    ...
                    <span className="text-[10px] font-semibold text-primary-dark">Parent</span>
                </div>
                {/* QR code */}
                <div className="flex flex-col items-center gap-1">
                    ...
                    >
                        <svg viewBox="0 0 24 24" fill="none" stroke="#6D98C2" strokeWidth="1.5" className="w-7 h-7">
                ...
                <div className="w-20 sm:w-24 h-36 sm:h-44 rounded-2xl border-2 border-emerald-300/40 bg-emerald-50/50 flex flex-col items-center justify-center gap-2">
                    ...
                    <span className="text-[10px] font-semibold text-emerald-700">Enfant</span>
                </div>
            </div>
        ),
    },
    {
        ...
        description:
            "Compteur en temps reel. Temps gagne, temps depense, temps restant. Pas de surprise.",
        visual: (
            <div className="flex flex-col items-center gap-4">
                {/* Timer display */}
                <div className="relative w-32 h-32 sm:w-36 sm:h-36">
                    <svg viewBox="0 0 120 120" className="w-full h-full">
                        <circle cx="60" cy="60" r="52" fill="none" stroke="#EAF2FB" strokeWidth="8" />
                        <motion.circle
                            cx="60" cy="60" r="52" fill="none" stroke="#6D98C2" strokeWidth="8"
                            strokeLinecap="round"
                    ...
                    <div className="absolute inset-0 flex flex-col items-center justify-center">
                        ...
                        <span className="text-[10px] text-slate-400 font-medium">min restantes</span>
                    </div>
                </div>
                {/* Mini stats */}
                <div className="flex gap-4 text-center">
                    <div>
                        ...
                        <p className="text-[10px] text-slate-400">gagnees</p>
                    </div>
                    <div className="w-px bg-slate-200" />
                    <div>
                        <p className="text-sm font-bold text-amber-500">-18</p>
                        <p className="text-[10px] text-slate-400">utilisees</p>
                    </div>
                </div>
            </div>
        ),
    ...
    {
        title: "Des missions, pas des punitions",
        description:
            "Creez une mission : 'Range ta chambre'. L'enfant prend une photo. Vous validez. Bonus accorde.",
        visual: (
            <div className="w-full max-w-[240px] mx-auto">
                <motion.div
                    className="bg-white rounded-2xl border border-slate-200 shadow-lg shadow-slate-900/5 overflow-hidden"
                    whileHover={{ y: -4 }}
                >
                    <div className="bg-gradient-to-r from-primary to-primary-dark px-4 py-2.5">
                        <p className="text-white text-xs font-semibold">Mission</p>
                    </div>
                    <div className="p-4 space-y-3">
                        <p className="text-sm font-semibold text-slate-900">Range ta chambre</p>
                        ...
                        <div className="flex items-center justify-between">
                            <span className="text-xs font-semibold text-emerald-600 bg-emerald-50 px-2 py-1 rounded-full">+15 min bonus</span>
                            <motion.div
    ...
    },
    {
        ...
        description:
            "Protection anti-desinstallation. Blocage par plages horaires. Meme hors-ligne, les regles s'appliquent.",
        visual: (
            <div className="flex flex-col items-center gap-3">
                ...
                >
                    <svg viewBox="0 0 100 100" className="w-full h-full">
                        ...
                        <path d="M44 46 V38 C44 34 47 31 50 31 C53 31 56 34 56 38 V46" fill="none" stroke="#6D98C2" strokeWidth="3" strokeLinecap="round" />
                        <circle cx="50" cy="56" r="3" fill="white" />
                    </svg>
                </motion.div>
                <div className="flex gap-2">
                    {["Ecole", "Nuit", "Repas"].map((label) => (
                        <span key={label} className="px-2.5 py-1 rounded-full bg-red-50 text-red-400 text-[10px] font-semibold border border-red-100">
                            {label}
                        </span>
                    ))}
                </div>
