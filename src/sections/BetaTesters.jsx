...
const valueProps = [
    {
        ...
        text: "100% gratuit pendant la beta",
    },
    {
        icon: (
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className="w-5 h-5 text-primary">
        ...
        text: "Acces direct aux developpeurs",
    },
    {
        icon: (
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className="w-5 h-5 text-primary">
        ...
        text: "Vos idees dans la prochaine version",
    },
];
        ...
        <section id="beta" className="relative py-24 sm:py-28 overflow-hidden bg-gradient-to-b from-primary-very-light/40 via-white to-white">
            ...
            <Container className="relative z-10">
                <div ref={ref} className="max-w-2xl mx-auto text-center">
                    ...
                    >
                        Vous ne telechargez pas une app.
                        <br />
                        <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary to-primary-dark">
                            Vous construisez la votre.
                        </span>
                    </motion.h2>
                    ...
                    >
                        El&Moi est en beta. Ca veut dire que vous faites partie des premiers
                        parents a tester, a critiquer, a ameliorer. Votre avis change le produit.
                        Litteralement.
                    </motion.p>
